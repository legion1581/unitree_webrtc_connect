...
# R1 always uses the data2=3 auth path, so the per-device AES-128 key is
# required. Fetch with `unitree-fetch-aes-key --device-type R1` and set
# UNITREE_AES_128_KEY, or paste below.
